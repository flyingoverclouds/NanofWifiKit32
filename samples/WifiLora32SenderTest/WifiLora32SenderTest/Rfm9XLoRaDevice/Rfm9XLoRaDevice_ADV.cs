...
//---------------------------------------------------------------------------------
//
// NCLERC : 06/01/2021 : code update formigration to Windows.Devices.Gpio
//
...
namespace devMobile.IoT.Rfm9x
{
	...
	public sealed class Rfm9XDevice_ADV
	{
		...
		public Rfm9XDevice_ADV(string spiPortName, int chipSelectPin, int resetPinNumber, int interruptPinNumber)
		{
		...
		public Rfm9XDevice_ADV(string spiPortName, int chipSelectPin, int interruptPinNumber)
		{
			RegisterManager = new RegisterManager(spiPortName, chipSelectPin);
